                        ...
                        <div className='tab-content'>
                            <div className="tab-pane fade show active" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
                                <form>
                                    ...
                                    <br />
                                    <div className="form-floating">
                                        <input type="text" id="registerUsername" className="form-control" onChange={registerHandleChange} name='surname' placeholder='Surname' required={true} />
                                    ...
                                    <div className='a text-center'>
                                        <div className='a2'>
                                            <button onClick={(e) => register(e)} type="submit" className="btn btn-primary btn-block">SignUp</button>
                                            <button onClick={() => navigate('/login')} type="submit" className="btn btn-danger btn-block ">Cancel</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
