...
<div className="two-box-modal">
      ...
      <div className="box right-box">
        ...
        >
          ...
          <div class="containerLog">
            <div>
                <Link to={'/login'} id='buttonn' class="btn log">Login</Link>
                <Link to={'/register'} id='buttonn' class="btn reg">Sign up</Link>
            </div>
          </div>
        </div>
        <br></br>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              ...
              <p class="lead mb-4">Nuestro motor de búsqueda de hoteles está dedicado a encontrar las mejores opciones de hospedaje para nuestros usuarios, ofreciendo información precisa y confiable para que puedan tomar decisiones informadas y disfrutar de una experiencia de hospedaje agradable y sin problemas.</p>
            </div>
            <div class="col-md-6">
              <img src={AboutU} alt="Imagen de nosotros" class="img-fluid" />
            </div>
          </div>
        </div>
      </section>
      <section style={{ backgroundImage: `url(${backgrAubot})`, backgroundSize: 'cover', paddingTop: '5%', marginTop: '-3%', paddingBottom: '5%' }}>
        <div class="row">
          ...
          <div class="col-md-4" style={{ marginLeft: '20px' }}>
            <h2 class="mb-4" >¿A dónde quieres viajar?</h2>
            <p class="lead mb-4" style={{ width: "90%" }}>Selecciona el destino al cual deseas viajar para tener las mejores ofertas y los hoteles con mayor calificación </p>
            <SideBarMini />
