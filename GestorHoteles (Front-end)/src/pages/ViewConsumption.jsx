                                            ...
                                            <div className="car-body p-0">
                                                <div className="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style={{ position: 'relative', height: '500px' }}>
                                                    <table className="table table-striped ">
                                                        ...
                                                        <tbody>
                                                            {
                                                                tableConsumption.map(({_id, product, price}, index) => {
                                                                    return(
                                                                        <tr key={index}>
                                                                            <TableConsumption
                                                                            product={product}
                                                                            ...
                                                                            <div className="btn-group align-top">
                                                                                <div className="btn btn-sm btn-primary btn-outline-secondary badge">
                                                                                    <button onClick={() => navigate(`/updateConsumption/${_id}`)} className="btn badge" type="button" data-toggle="modal" data-target="#user-form-modal">
